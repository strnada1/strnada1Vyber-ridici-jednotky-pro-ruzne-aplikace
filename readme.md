...
| **MPU**                  |                                       | Samostatný procesor vyžadující externí RAM a úložiště, zpravidla běží plnohodnotný OS (Linux)        |  Raspberry pi, Microchip SAMA5D2            |                                          |
| **Embedded**             |                                       | jednoúčelový počítačový systém, který je pevně součástí většího zařízení a plní v něm konkrétní, předem určený úkol.   | Embedded PLC, Embedded          | Bílá technika, bankomaty, regulace kotlů |
| **PLC**                  |                                       | Průmyslový automat pro cyklické deterministické řízení procesů, vysoká odolnost, modulární/kompaktní |  Allen-Bradley Micro800, Omron Sysmac NX1   |                                          |
| **iPC**                  |                                       | běžný PC upravený pro neustálý provoz a odolný vůči prachu vibracím a vysokým teplotám               |  Advantech UNO 2000, Beckhoff C6015         |                                          |
| **Programovatelné relé** |                                       | Zjednodušené kompaktní PLC pro méně náročné úlohy, nahrazuje časovací relé a stykačové kombinace     | rodina Siemens LOGO!                        |                                          |
