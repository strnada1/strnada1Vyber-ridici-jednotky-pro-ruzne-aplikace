...
| :----------------------- | :------------------------------------ | :--------------------------------------------------------------------------------------------------- | :------------------------------------------ | :--------------------------------------- |
| **MCU**                  | Micro controller | Integrovaný čip (CPU + RAM + Flash na jednom substrátu), deterministický běh bez OS nebo RTOS | např. ESP32, PIC16LF1xxx, RP2040  |                                          |
| **MPU**                  | Micro Processor | Samostatný procesor vyžadující externí RAM a úložiště, zpravidla běží plnohodnotný OS (Linux) |  Raspberry pi, Microchip SAMA5D2 |                                          |
...
| **PLC**                  | Programmable logic controller | Průmyslový automat pro cyklické deterministické řízení procesů, vysoká odolnost, modulární/kompaktní |  Allen-Bradley Micro800, Omron Sysmac NX1   |                                          |
| **iPC**                  | industrial/průmyslový PC | běžný PC upravený pro neustálý provoz a odolný vůči prachu vibracím a vysokým teplotám |  Advantech UNO 2000, Beckhoff C6015         |                                          |
